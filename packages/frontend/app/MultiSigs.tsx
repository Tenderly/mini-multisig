      ...
      <Dialog>
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => (review ? setReview(false) : reset())}>
              Cancel
            </Button>
          </DialogFooter>
        </DialogContent>
...
function Transaction({
  ...
  return (
    <div className="mb-10">
      ...
      {me.address && transaction.approvedBy.indexOf(me.address) == -1 && (
        <span className="mr-2">
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w[512px]">
        ...
        <DialogFooter>
          ...
          {reviewing && (
            <Button onClick={() => setReviewing(false)}>Modify</Button>
          )}
          {reviewing && (
            <Button onClick={() => setReviewing(false)}>Create</Button>
          )}
        </DialogFooter>
      </DialogContent>
    </Dialog>
